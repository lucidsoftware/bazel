...
public interface SimpleBlobStore {
   ...
   */
  ListenableFuture<Boolean> get(String key, Digest digest, OutputStream out);
   ...
   */
  void put(String key, Digest digest, long length, Chunker chunker, InputStream in) throws IOException, InterruptedException;
